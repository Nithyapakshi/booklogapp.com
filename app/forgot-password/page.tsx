  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-4" style={{ background: "#faf7f2", fontFamily: "DM Sans, sans-serif" }}>
      ...
      <div className="w-full" style={{ maxWidth: "400px", background: "#fff", border: "0.5px solid #e0d5c4", borderRadius: "12px", padding: "2rem" }}>
        ...
        {!submitted ? (
          <>
            <h1 style={{ fontFamily: "Georgia, serif", fontSize: "22px", color: "#1a1208", fontWeight: "normal", marginBottom: "4px" }}>Reset your password</h1>
            <p style={{ fontSize: "13px", color: "#8a7560", marginBottom: "1.5rem" }}>Enter your email and we'll send a reset link</p>
          ...
          <>
            <h1 style={{ fontFamily: "Georgia, serif", fontSize: "22px", color: "#1a1208", fontWeight: "normal", marginBottom: "4px" }}>Check your email</h1>
            <p style={{ fontSize: "13px", color: "#8a7560", marginBottom: "1.5rem" }}>
              If an account exists for <strong style={{ color: "#1a1208" }}>{email}</strong>, you'll receive a reset link shortly.
            </p>
            <p style={{ textAlign: "center", fontSize: "12px", color: "#8a7560", marginTop: "1.25rem" }}>
              <Link href="/login" style={{ color: "#c17f3e", textDecoration: "none", fontWeight: "500" }}>
                ← Back to login
