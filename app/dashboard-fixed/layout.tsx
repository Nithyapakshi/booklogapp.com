...
export default function DashboardFixedLayout({
  children,
}: {
      ...
      <header className="border-b">
        <div className="container flex h-16 items-center justify-between py-4">
          ...
          <nav className="flex items-center gap-4">
            <Link href="/dashboard-fixed" className="text-sm font-medium text-gray-900">
              Dashboard
            </Link>
            <Link href="/books" className="text-sm font-medium text-gray-600 hover:text-gray-900">
              My Books
            </Link>
            <Link href="/debug/auth" className="text-sm font-medium text-gray-600 hover:text-gray-900">
              Debug Auth
            </Link>
